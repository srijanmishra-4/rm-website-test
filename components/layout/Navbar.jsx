...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Overlay and drawer live OUTSIDE the header so the sticky header's
          stacking context / fixed height cannot interfere with them. */}
      <div
        className={`fixed inset-0 z-[100] bg-black/35 transition-opacity duration-300 lg:hidden ${
          mobileOpen
      ...
      <div
        ...
        inert={!mobileOpen}
        className={`fixed top-0 right-0 z-[110] flex h-full w-[min(20rem,86vw)] flex-col bg-white shadow-[-8px_0_30px_rgba(0,0,0,0.12)] transition-[transform,visibility] duration-300 ease-out lg:hidden ${
