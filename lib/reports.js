 ...
 * Preserves backend dynamic key and value, plus volume, chg_in_vol, oi, chg_in_oi.
 */
function normalizeTypeARow(row) {
  ...
  return {
    ...
    chg_in_vol: toNumber(row.chg_in_vol ?? row.changeInVolume ?? row.change_in_volume),
    oi: toNumber(row.oi),
 ...
 * Preserves strike_pr, remark, tp, volume, chg_in_vol, oi, chg_in_oi.
 */
